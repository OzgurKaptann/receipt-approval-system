...
class UploadedDocument(Base):
    ...
    receipt_amount_try: Mapped[float] = mapped_column(Numeric(18, 2), nullable=False)
    ...
    tg_decided_at: Mapped[str | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    slack_decided_at: Mapped[str | None] = mapped_column(DateTime(timezone=True), nullable=True)
